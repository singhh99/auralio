            ...
            <div class="main-panel">
             <div class="content-wrapper">
               <div class="card">
                 <div class="card-body">
                   <h4 class="card-title">
                     <button type="button" class="btn btn-primary btn-fw" data-toggle="modal" data-target="#exampleModal-4" data-whatever="@fat" >Add New Country</button>
                   </h4>
                    ...
                    @foreach($country_list as $key)
                     <tr>
                        ...
                        <td >
                           ...
                           <a href="{{url('/Country')}}/{{$key->country_id}}/destroy">
