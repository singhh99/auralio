      ...
      <div class="content-wrapper">
         <div class="row">
            ...
            <div class="col-12 grid-margin">
               <div class="card">
                  <h4 class="" style="background: #744df9;color: white;  padding: 10px 0 10px 21px;">Edir Owner Information</h4>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-9">
                                    <input type="text" class="form-control @error('owner_pan_number') is-invalid @enderror" name="owner_pan_number" placeholder="Owner Pan Number" value="{{$info->owner_pan_number}}" required="">
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-9">
                                    <input type="text" class="form-control @error('owner_bank_name') is-invalid @enderror" name="owner_bank_name" placeholder="Owner Bank Name" value="{{$info->owner_bank_name}}" required="" >
                           ...
                           <div class="col-md-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-9">
                                    <input type="text" class="form-control @error('owner_IFSC_code') is-invalid @enderror" name="owner_IFSC_code" placeholder="Owner IFSC Code" value="{{$info->owner_IFSC_code}}"  required="">
                           ...
                           <div class="col-md-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-9">
                                    <input type="number" class="form-control @error('owner_account_number') is-invalid @enderror" name="owner_account_number" placeholder="Owner Account Number" value="{{$info->owner_account_number}}" required="">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-9">
                                    <input type="text" class="form-control" name="saloon_address" placeholder="Owner IFSC Code" value="{{$info->saloon_address}}" required="">
                                    <small style="color: red"></small>
                                 </div>
                              </div>
                           </div>
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-9">
                                    <div class="form-group">
                                       <select class="js-example-basic-multiple" name="saloon_working_days[]" multiple="multiple" style="width:100%" required="">
                                          @if($info->saloon_working_days != '')
                                             <option value="Sunday"  @foreach(json_decode($info->saloon_working_days) as $itm) {{ $itm == "Sunday" ? "selected" : "" }}@endforeach>Sunday</option>
                                             <option value="Monday" @foreach(json_decode($info->saloon_working_days) as $itm) {{ $itm == "Monday" ? "selected" : "" }}@endforeach>Monday</option>
                                             <option value="Tuesday"  @foreach(json_decode($info->saloon_working_days) as $itm) {{ $itm == "Tuesday" ? "selected" : "" }}@endforeach>Tuesday</option>
                                             <option value="Wednesday" @foreach(json_decode($info->saloon_working_days) as $itm) {{ $itm == "Wednesday" ? "selected" : "" }}@endforeach >Wednesday</option>
                                             <option value="Thursday" @foreach(json_decode($info->saloon_working_days) as $itm) {{ $itm == "Thursday" ? "selected" : "" }}@endforeach >Thursday</option>
                                             <option value="Fiday" @foreach(json_decode($info->saloon_working_days) as $itm) {{ $itm == "Friday" ? "selected" : "" }}@endforeach>Friday</option>
                                             <option value="Saturday" @foreach(json_decode($info->saloon_working_days) as $itm) {{ $itm == "Saturday" ? "selected" : "" }}@endforeach>Saturday</option>
                                          @else
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-9 icheck-flat">
                                    @foreach($feature_list as $key)
                                     <input tabindex="5" type="checkbox" name="saloon_feature_id[]" id="flat-checkbox-1" value="{{$key->feature_id}}"  @foreach(json_decode($info->saloon_feature_id) as $itm) {{ $itm == $key->feature_id ? "checked" : "" }}@endforeach>
