...
<div class="container-fluid page-body-wrapper">
    <div class="main-panel">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12  stretch-card">
                <div class="main-panel">
                    <div class="content-wrapper">
                    <a href="{{url('/')}}"><button type="button" class="btn btn-primary btn-fw" style="float:right;margin: right 20px ;">back</button></a>

                    <div class="row"> 
                       <h3>Rescheduled Bookings</h3>
                        <div class="col-md-2">
                        <a href="{{url('/todayrescheduledbookings')}}"><button type="button" class="btn btn-outline-primary btn-block"><i class="fa fa-book"></i>Todays({{$count_bookings}})</button></a>
                        </div>
                   </div>
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-hover" style="font-weight:normal !important;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="{{$key->booking_status_id}}">{{$key->booking_status_id}}</td>
