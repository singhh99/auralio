               ...
               <div class="card">
                 <div class="card-body">
                  <div id="success-alert"> 
                   ...
                   <h4 class="card-title">
                    <a href="{{url('/Role/create')}}"><button type="button" class="btn btn-primary btn-fw">Add Role</button></a>
                   </h4>
                  ...
                  <tbody>
                    ...
                    @foreach($role_list as $key)
                     <tr>
                        ...
                        <td>{{$key->role_name}}</td>
                        <td >
                           <a href="{{url('/Role')}}/{{$key->role_id}}/edit">
                           <button class="btn btn-outline-success">View</button>
                           </a>
                           <!-- <a href="{{url('/Booking-Status')}}/{{$key->booking_status_id}}">
                           <button class="btn btn-outline-danger">Delete</button>
                           </a> -->
                           <form method="Post" action="{{url('Role')}}/{{$key->role_id}}">
                            @csrf
